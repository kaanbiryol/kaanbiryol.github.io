...
import remarkDataCharts from './src/plugins/remark-data-charts.mjs'
...
export default defineConfig({
  ...
  markdown: {
    processor: unified({
      ...
      rehypePlugins: [rehypeKatex, rehypeCleanup, rehypeImageProcessor, rehypeCopyCode, rehypeHeadingLinks]
    }),
    shikiConfig: {
      themes: {
        light: 'github-light',
